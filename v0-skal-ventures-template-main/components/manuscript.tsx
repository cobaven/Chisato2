...
const chapters = [
  {
    ...
    excerpt: "The first breath of a world that had forgotten its own name.",
    pages: "12 pages",
  },
  {
    number: "02",
    title: "Chapter 2: Mysterious Approach",
    excerpt: "Something arrives from beyond the edge of the map, without a name.",
    pages: "14 pages",
  },
  {
    number: "03",
    title: "Chapter 3: Pretty Acquaintance Around Here",
    excerpt: "A stranger walks into the tavern and the rules begin to change.",
    pages: "11 pages",
  },
  {
    number: "04",
    title: "Chapter 4: School Days",
    excerpt: "The bell rings. The ink is still wet. The lesson begins.",
    pages: "13 pages",
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {chapters.map((chapter) => (
            <Link
              ...
              className="group relative block p-8 border border-foreground/10 bg-card hover:border-primary/50 transition-all duration-300 overflow-hidden"
            >
