  ...
  return (
    <section id="about" className="relative py-28 px-4 md:px-8 lg:px-12 bg-background">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <Reveal className="lg:col-span-9" delay={150}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Reveal className="md:col-span-2 space-y-6 text-foreground/80 leading-relaxed" delay={200}>
              <p className="text-lg">
            ...
            <Reveal delay={300}>
              <div className="relative group">
                <div className="aspect-[3/4] border border-foreground/10 bg-card overflow-hidden transition-all duration-500 group-hover:shadow-[0_8px_30px_rgba(232,196,107,0.15)] group-hover:border-primary/30">
