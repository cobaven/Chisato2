        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Reveal delay={100}>
            <a
              ...
              className="group relative flex flex-col gap-4 p-8 border border-foreground/10 bg-card hover:border-primary/50 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(232,196,107,0.12)] transition-all duration-300"
            >
              ...
              <div className="relative z-10">
                <span className="font-sentient text-xl text-foreground group-hover:text-primary transition-colors duration-300">hello@heavensorder.archive</span>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal delay={200}>
            ...
            >
              ...
              <div className="relative z-10">
                <span className="font-sentient text-xl text-foreground group-hover:text-primary transition-colors duration-300">@gauravkumarpatra</span>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal delay={300}>
            ...
            >
              ...
              <div className="relative z-10">
                <span className="font-sentient text-xl text-foreground group-hover:text-primary transition-colors duration-300">Gaurav Kumar Patra</span>
              </div>
            </a>
          </Reveal>
        </div>
