            ...
            {unlocked ? (
              <div className="text-center">
                ...
                <p className="text-foreground/70 text-lg max-w-xl mx-auto">
                  Access granted. The restricted manuscript is now open.
                </p>
                <div className="mt-8">
                  <Link href="/chapter/1">
              ...
              <>
                <div className="flex items-center justify-between mb-8">
                  ...
                  <span className="font-mono text-[11px] tracking-[0.3em] text-foreground/30">
                    ACCESS RESTRICTED // {ACCESS_CODE.length} DIGITS
                  </span>
                </div>
                ...
                {error && (
                  <p className="mt-4 font-mono text-[11px] tracking-[0.2em] text-red-500/80">
